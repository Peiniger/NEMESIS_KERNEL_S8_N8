...
export VARIANT=eur
export ARCH=arm64
export BUILD_CROSS_COMPILE=/home/geiti94/android/toolchain/aarch64-cortex_a53-linux-gnueabi-gcc/bin/aarch64-cortex_a53-linux-gnueabi-
...
FUNC_BUILD_DTIMAGE_TARGET()
{
	...
	greatlte)
		...
		can|duos|eur|xx)
			DTSFILES="exynos8895-greatlte_eur_open_00 exynos8895-greatlte_eur_open_01
					...
					exynos8895-greatlte_eur_open_05
	...
	dreamlte)
		case $VARIANT in
		can|duos|eur|xx)
			DTSFILES="exynos8895-dreamlte_eur_open_01 exynos8895-dreamlte_eur_open_02
					exynos8895-dreamlte_eur_open_03 exynos8895-dreamlte_eur_open_04
					exynos8895-dreamlte_eur_open_05 exynos8895-dreamlte_eur_open_07 exynos8895-dreamlte_eur_open_08 exynos8895-dreamlte_eur_open_09 exynos8895-dreamlte_eur_open_10"
			;;
		*)
			echo "Unknown variant: $VARIANT"
			exit 1
...
FUNC_BUILD_RAMDISK()
{
	...
	greatlte)
		case $VARIANT in
		can|duos|eur|xx)
			rm -f $RDIR/ramdisk/SM-N950F/split_img/boot.img-zImage
			rm -f $RDIR/ramdisk/SM-N950F/split_img/boot.img-dtb
			mv -f $RDIR/arch/$ARCH/boot/boot.img-zImage $RDIR/ramdisk/SM-N950F/split_img/boot.img-zImage
			mv -f $RDIR/arch/$ARCH/boot/boot.img-dtb $RDIR/ramdisk/SM-N950F/split_img/boot.img-dtb
			cd $RDIR/ramdisk/SM-N950F
			./repackimg.sh
...
FUNC_BUILD_ZIP()
{
	...
	greatlte)
		case $VARIANT in
		can|duos|eur|xx)
			mv -f $RDIR/ramdisk/SM-N950F/image-new.img $RDIR/build/$MODEL-$VARIANT.img
			;;
		*)
			echo "Unknown variant: $VARIANT"
			exit 1
